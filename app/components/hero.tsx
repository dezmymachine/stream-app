    ...
    >
      ...
      <div className="relative z-10 flex h-full w-full items-end pb-[15vh] lg:pb-[10vh]">
        <div className="container mx-auto flex w-full flex-col gap-4 px-6 text-white md:px-12 lg:max-w-7xl lg:px-16">
          ...
          <p className="max-w-xl text-sm line-clamp-3 leading-relaxed text-shadow-2xs text-white/90 md:text-base">
            {active.overview}
          </p>
      ...
      {/* Desktop arrows (hidden on <md) */}
      <button
        onClick={prev}
        className="apple-arrow left-4 hidden md:block"
        aria-label="Previous"
      >
        <svg
          className="h-6 w-6"
      ...
      <button
        onClick={next}
        className="apple-arrow right-4 hidden md:block"
        aria-label="Next"
      >
        <svg
          className="h-6 w-6"
